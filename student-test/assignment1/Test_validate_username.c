...
void test_validate_my_username()
{
     ...
     */
    const char* my_name1 = my_username();
    const char* my_name2 = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_name1, my_name2,"AESD students, please fix me!");
}
